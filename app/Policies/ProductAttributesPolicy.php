...
class ProductAttributesPolicy
{
     ...
     */
    public function view(User $user, ProductAttributes $productAttributes): bool
    {
     ...
     */
    public function update(User $user, ProductAttributes $productAttributes): bool
    {
     ...
     */
    public function delete(User $user, ProductAttributes $productAttributes): bool
    {
     ...
     */
    public function forceDelete(User $user, ProductAttributes $productAttributes): bool
    {
     ...
     */
    public function restore(User $user, ProductAttributes $productAttributes): bool
    {
     ...
     */
    public function replicate(User $user, ProductAttributes $productAttributes): bool
    {
